...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ChangeDTO<Object>> handleMultipartExceptions(MultipartException ex) {

        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(new ChangeDTO<>(State.Fail, "Multipart request problem: " + ex.getMessage() , null));
    }
}